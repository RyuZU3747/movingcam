...
joints_name_24 = (      # Hybrik skeleton
        'pelvis', 'left_hip', 'right_hip',      # 2
        'spine1', 'left_knee', 'right_knee',    # 5
        'spine2', 'left_ankle', 'right_ankle',  # 8
        'spine3', 'left_foot', 'right_foot',    # 11
        'neck', 'left_collar(쇄골)', 'right_collar',  # 14
        'jaw(턱)',                                  # 15
...
name_idx_map = { ## to Hybrik
    'j_root': 0,            #'pelvis'
    'j_thigh_left' : 1,       #'left_hip'
    'j_shin_left' : 4,        #'left_knee'
    'j_heel_left' : 7,        #'left_ankle'
    'j_thigh_right' : 2,      #'right_hip'
    'j_shin_right' : 5,       #'right_knee'
    'j_heel_right' : 8,       #'right_ankle'
    'j_abdomen' : 3,          #'spine1'
    'j_spine' : 6,            #'spine3'
    'j_neck' : 12,            #'neck'
    'j_head' : 15,            #'jaw'
    'j_scapula_left' : 13,    #'left_collar'
    'j_bicep_left' : 16,      #'left_shoulder'
    'j_forearm_left' : 18,    #'left_elbow'
    'j_hand_left' : 20,       #'left_wrist'
    'j_scapula_right' : 14,   #'right_collar'
    'j_bicep_right' : 17,     #'right_shoulder'
    'j_forearm_right' : 19,   #'right_elbow'
    'j_hand_right' : 21,      #'right_wrist'
}
...
if __name__ == "__main__":
    ...
    with open("/home/vboxuser/movingcam/ik/postpost31_res.pk", "rb") as f:   
    ...
    pydart.init()
    world = pydart.World(1./30., '/home/vboxuser/movingcam/data/skel/human_mass_limited_dof_v2.skel')
    ...
    missing_frames = []
    frame_ids = [i for i in range(frame_num)]
    ...
    motion.save('/home/vboxuser/movingcam/ik/postpost31.skmo')
