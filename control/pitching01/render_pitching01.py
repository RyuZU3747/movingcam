...
import torch
from control.pitching01.pitching01_ppo_mp import PPO
...
def main():
    ...
    if not MOTION_ONLY:
        ...
        ppo.LoadModel('pitching01_model_202308301614/' + 'max.pt')
        # ppo.LoadModel('pitching01_model_202308211652/' + 'max.pt')
        ppo.model.eval()
