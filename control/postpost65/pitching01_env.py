...
class SkateDartEnv(gym.Env):
    def __init__(self, ):
        ...
        self.world = pydart.World(1./150., cur_path+'/../../data/skel/human_mass_limited_dof_v2_ball_mound_65.skel')
        ...
        self.ref_world = pydart.World(1./150., cur_path+'/../../data/skel/human_mass_limited_dof_v2_ball_mound_65.skel')
        self.ref_skel = self.ref_world.skeletons[1]
        self.ref_motion = DartSkelMotion()
        # self.ref_motion.load(cur_path + '/pitching01_vibe_dof_limit_v2.skmo')
        # self.ref_motion.load(cur_path + '/pitching01.skmo')
        self.ref_motion.load(cur_path + '/postpost65.skmo')
        # self.ref_motion.load(cur_path + '/hybrik_pitching01_v23.skmo')
...
###
        ...
        # self.idx_e = [self.skel.bodynode_index('h_hand_right'),
        #               self.skel.bodynode_index('h_heel_left'), self.skel.bodynode_index('h_heel_right')]
        ...
        for json_file in sorted(glob.glob(json_path + "*.json")):
            ...
            if json_file == json_path+"postpost65_000000000105_keypoints.json":
                for i in range(10):
    ...
    def reward(self):
        ...
        # lower the weight of left arm 0.1
        skel_pos_diff = self.skel.position_differences(self.skel.q, self.ref_skel.q)
        skel_pos_diff[16:28] = 1.0*skel_pos_diff[16:28]
        ...
        skel_vel_diff[16:28] = 1.0 * skel_vel_diff[16:28]
        ...
        ##
        # if(self.current_frame == self.ball_released_frame):
        #     right_hand_pos = self.skel.joint('j_forearm_right').position_in_world_frame()
        #     hand_to_target_vec = self.target_zone_pos - right_hand_pos
        #     # hand_to_target_vec = mm.normalize(hand_to_target_vec)
        #     # hand_to_target_vec = np.linalg.norm(hand_to_target_vec)
        #     print("hand_to_target_vec ",hand_to_target_vec)
        #     ball_angle = 
