...
from control.postpost65.pitching01_env import SkateDartEnv
# from skate_env import SkateDartEnv
...
class PPO(object):
    def __init__(self, env_name, num_slaves=1, eval_print=True, eval_log=True, visualize_only=False):
        ...
        self.saved = False
        self.save_directory = self.env_name + '_' + 'gogo'+ '/'
    ...
    def SaveModel(self, filename):
        ...
        # torch.save(self.model.state_dict(), self.save_directory + f'{self.num_evaluation:05d}.pt')
...
if __name__ == "__main__":
    ...
    ppo = PPO('postpost65', 16)
    # ppo.LoadModel('postpost65_gogo/' + 'max.pt')
