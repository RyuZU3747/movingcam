...
class SkateDartEnv(gym.Env):
    def __init__(self, ):
        ...
        self.ref_motion.load(cur_path + '/hybrik_pitching01.skmo')
        # self.ref_motion.load(cur_path + '/hybrik_pitching01_v23.skmo')
        self.ref_motion.reset_root_trajectory_pitching01_hybrik_on_mound(self.ref_skel)
...
###
        ...
        for json_file in sorted(glob.glob(json_path + "*.json")):
            ...
            if json_file == json_path+"pitching01_0000000000120_keypoints.json":
                for i in range(10):
