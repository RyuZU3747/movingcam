...
class SkateDartEnv(gym.Env):
    def __init__(self, ):
        ...
        self.world = pydart.World(1./150., cur_path+'/../../data/skel/human_mass_limited_dof_v2_ball_mound_H_movingcam.skel')       
        ...
        self.ref_world = pydart.World(1./150., cur_path+'/../../data/skel/human_mass_limited_dof_v2_ball_mound_H_movingcam.skel')
        ...
        self.ref_motion.reset_root_trajectory_pitching01_hybrik_on_mound_movingcam(self.ref_skel)
