...
def main():
    ...
    # print(dartSkelRenderer.getState())
    ...
    def simulateCallback(frame):
        ...
        if frame%10 ==0 or 105 > frame > 75:
            ...
            if frame > 85:
                render_color.append((0, 255, 0))
            elif frame > 75:
                render_color.append((255-2*frame, 255, 255-2*frame)) 
            else:
                render_color.append((255-  3*frame, 255, 255- 3*frame))
