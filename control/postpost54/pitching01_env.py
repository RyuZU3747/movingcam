...
class SkateDartEnv(gym.Env):
    def __init__(self, ):
        ...
        self.world = pydart.World(1./150., cur_path+'/../../data/skel/human_mass_limited_dof_v2_ball_mound_54.skel')
        ...
        self.ref_world = pydart.World(1./150., cur_path+'/../../data/skel/human_mass_limited_dof_v2_ball_mound_54.skel')
        ...
        self.ref_motion.load(cur_path + '/postpost54.skmo')
        # self.ref_motion.load(cur_path + '/hybrik_pitching01_v23.skmo')
        self.ref_motion.reset_root_trajectory_postpost54(self.ref_skel)
...
###
        ...
        for json_file in sorted(glob.glob(json_path + "*.json")):
            ...
            if json_file == json_path+"postpost54_000000000082_keypoints.json":
                for i in range(10):
    ...
    def reward(self):
        ...
        skel_pos_diff[16:28] = 0.05*skel_pos_diff[16:28]
        ...
        skel_vel_diff[16:28] = 0.05 * skel_vel_diff[16:28]
