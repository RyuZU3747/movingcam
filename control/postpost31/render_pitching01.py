...
import torch
from control.postpost31.pitching01_ppo_mp import PPO
...
def main():
    ...
    if not MOTION_ONLY:
        ...
        # ppo.LoadModel('postpost54_model_202309181359/' + '10006.pt')

        # ppo.LoadModel('postpost31_model_202309221755/' + 'max.pt')
    ...
    def simulateCallback(frame):
        ...
        if not isLeft :
            ...
            forearm_idx = 20
            hand_idx = 21
        if (frame%10 == 0 and frame < 65 ) or 90 > frame > 65:
            # not mound
