...
class SkateDartEnv(gym.Env):
    def __init__(self, ):
        ...
        self.world = pydart.World(1./150., cur_path+'/../../data/skel/human_mass_limited_dof_v2_ball_mound_31.skel')
        ...
        self.ref_world = pydart.World(1./150., cur_path+'/../../data/skel/human_mass_limited_dof_v2_ball_mound_31.skel')
        ...
        self.ref_motion.load(cur_path + '/postpost31.skmo')
        # self.ref_motion.load(cur_path + '/hybrik_pitching01_v23.skmo')
        self.ref_motion.reset_root_trajectory_postpost31(self.ref_skel)
...
###
        ...
        for json_file in sorted(glob.glob(json_path + "*.json")):
            ...
            if json_file == json_path+"postpost31_000000000120_keypoints.json":
                for i in range(10):
    ...
    def reward(self):
        ...
        # print(ballreward)
        reward *= 100
        if self.ball.com()[2] < self.target_zone_pos[2]+0.1:
