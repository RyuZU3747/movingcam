...
class DartSkelMotion(object):
    ...
    def reset_root_trajectory_postpost54(self, skel):
        # print("reset root trajectory!!")
        frame_num = len(self.qs)

        for frame in range(frame_num):
            self.qs[frame][0] = 0.12
            # self.qs[frame][0] = -0.3
            self.qs[frame][1] = 1.
            self.qs[frame][2] = -0.15
            self.qs[frame][3] = 0.
            # self.qs[frame][4] = -0.03
            self.qs[frame][4] = 0.26
            self.qs[frame][5] = 0.

    def reset_root_trajectory_postpost31(self, skel):
        # print("reset root trajectory!!")
        frame_num = len(self.qs)

        for frame in range(frame_num):
            self.qs[frame][0] = 0.22
            # self.qs[frame][0] = -0.3
            self.qs[frame][1] = 1.
            self.qs[frame][2] = 0.
            self.qs[frame][3] = 0.
            # self.qs[frame][4] = -0.03
            self.qs[frame][4] = 0.25
            self.qs[frame][5] = 0.

    def reset_root_trajectory_postpost65(self, skel):
        # print("reset root trajectory!!")
        frame_num = len(self.qs)
        ...
        for frame in range(frame_num):
            ...
            self.qs[frame][3] = 0.
            # self.qs[frame][4] = -0.03
            self.qs[frame][4] = 0.255
            self.qs[frame][5] = 0.

    def reset_root_trajectory_pitching01_hybrik(self, skel):
        # print("reset root trajectory!!")
        frame_num = len(self.qs)
    ...
    def reset_root_trajectory_pitching01_hybrik_on_mound(self, skel):
        # print("reset root trajectory!!")
        frame_num = len(self.qs)
    ...
    def reset_root_trajectory_pitching01_hybrik_on_mound_movingcam(self, skel):
        # print("reset root trajectory!!")
        frame_num = len(self.qs)
        ...
        for frame in range(frame_num):
            ...
            self.qs[frame][3] = 0.0
            # self.qs[frame][4] = -0.03
            self.qs[frame][4] = 0.253
            self.qs[frame][5] = 0.
    
    

    def reset_root_trajectory_pitching01_vibe(self, skel):
        # print("reset root trajectory!!")
        frame_num = len(self.qs)
    ...
    def reset_root_trajectory_pitching01_vibe_on_mound(self, skel):
        # print("reset root trajectory!!")
        frame_num = len(self.qs)
    ...
    def reset_root_trajectory_pitching01(self, skel):
        frame_num = len(self.qs)

        for frame in range(frame_num):
            self.qs[frame][0] = 0.24
            self.qs[frame][1] = 0.9
            # self.qs[frame][1] = 1.8
            self.qs[frame][2] = -0.1
            self.qs[frame][3] = 0.
